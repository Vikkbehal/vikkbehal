    ...
    <section id='heroAbout'>
      ...
      <div className='social-links-wrapper'>
        <ul className='social-links'>
          <li className='mail'><Link to='#' onClick={() => window.location = 'mailto:vikkbehal@gmail.com'} target="_blank"><img src={Gmail} alt="vikkbehal_email" />vikkbehal@gmail.com</Link></li>
