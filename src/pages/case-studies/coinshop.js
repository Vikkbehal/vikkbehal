  ...
  return (
    <div id="case-study" className="main-wrapper">
      ...
      <div className="case-study-body-wrapper">
        <CaseStudyHeroCard
          sno="2"
          projectName="Coinshop (Mobile Apps)"
        ...
        <section className="content-wrapper">
          ...
          <p>
            ...
            Museum, KGB Cells Museum, Oskar Lots House Museum, and 19th Century
            Citizen's Museum. Together, the museums uniquely tell the story of
            Tartu focussing solely on the city and its progress throughout
            history.
          </p>
        </section>
        <section className="content-wrapper">
        ...
        <section className="content-wrapper">
          ...
          <div className="processWrapper">
            <img src={process} alt="UX Designer" />
          </div>
        </section>
        <section className="content-wrapper">
          <h3 className="title">
